...
import { 
    ...
    Loader2, User, ArrowRight, CheckCircle, BookOpen, Trophy, Users
} from 'lucide-react';
...
export default function Signup() {
    ...
    return (
        <div className="min-h-screen flex bg-gradient-to-br from-primary/5 via-background to-purple-500/5">
            {/* Left Panel - Branding */}
            <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-purple-600 to-primary p-12 flex-col justify-between text-white">
                <div>
                ...
                <div className="space-y-4">
                    ...
                    <div className="flex items-center gap-3">
                        <CheckCircle size={20} className="text-green-300" />
                        <span>Works offline - perfect for rural areas</span>
                    </div>
                    <div className="flex items-center gap-3">
                        <CheckCircle size={20} className="text-green-300" />
                    ...
                    <div className="flex items-center gap-3">
                        <CheckCircle size={20} className="text-green-300" />
                        <span>Connect with a learning community</span>
                    </div>
                </div>
                ...
                <div className="w-full max-w-md">
                    ...
                    <div className="bg-card border border-border rounded-2xl p-6 md:p-8 shadow-xl">
                        <div className="text-center mb-6">
                            ...
                            <p className="text-muted-foreground">Join P.E.E.R and start learning</p>
                        </div>
                                ...
                                <div className="p-3 bg-muted rounded-xl space-y-2">
                                    {passwordRequirements.map((req, i) => (
                                        <div key={i} className={`flex items-center gap-2 text-xs ${req.met ? 'text-green-600' : 'text-muted-foreground'}`}>
                                            <CheckCircle size={14} className={req.met ? 'text-green-500' : 'text-muted-foreground/50'} />
                                            {req.label}
                                        </div>
                                    ))}
                                </div>
